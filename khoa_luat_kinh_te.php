...
<body>
                ...
                <div class="modal-body">
                    <form id="form-signup" class="form-signin mt-2">
                        ...
                        <div class="custom-control custom-checkbox">
                            <p class="text-center">Bằng việc đăng ký, bạn đã đồng ý với Nhà sách HNVH về</p>
    ...
    <section class="breadcrumbbar">
        <div class="container">
            <ol class="breadcrumb mb-0 p-0 bg-transparent">
                ...
                <li class="breadcrumb-item active"><a href="khoa_luat_kinh_te.php">Khoa Luật kinh tế</a></li>
            </ol>
        </div>
    </section>
    ...
    <section class="banner">
        <div class="container">
            <a href="khoa_luat_kinh_te.php"><img src="images/khoa-luat.png" alt="khoa-luat"
                    class="img-fluid"></a>
        </div>
    </section>
    ...
    <section class="page-content my-3">
        <div class="container">
            <div>
                <h1 class="header text-uppercase">Khoa Luật kinh tế</h1>
            </div>
       ...
       <?php 
            ...
            $sql = "
                      ...
                      WHERE  ten_khoa = N'Khoa Luật kinh tế'
                    ";
